(function(ng, moment, _, undefined) {
    ...
    ng.module('app.controllers')
        .controller('MeasuresController', ["$scope", "$http", "GlobalsService", 
			function($scope, $http, GlobalsService) {
        var vm = this;

		$scope.title = 'Listado de mediciones';
        ...
        function paginatorCallback(page, pageSize) {
            ...
            return $http.get(GlobalsService.getAPIURL() + '/api/measures?' + $.param( params ) ).then(function(result){
