(function(ng, moment, _, undefined) {
    ...
    ng.module('app.controllers')
        .controller('ChannelsController', ["$scope", "$http", "GlobalsService", 
			function($scope, $http, GlobalsService) {
        var vm = this;

		$scope.title = 'Listado de canales';
        ...
        function paginatorCallback(page, pageSize) {
            ...
            return $http.get(GlobalsService.getAPIURL() + '/api/channels?' + $.param( params ) ).then(function(result){
