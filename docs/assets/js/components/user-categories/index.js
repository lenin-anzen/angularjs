(function(ng, moment, _, undefined) {
    ...
    ng.module('app.controllers')
        .controller('UserCategoriesController', ["$scope", "$http", "GlobalsService", 
			function($scope, $http, GlobalsService) {
        var vm = this;

		$scope.title = 'Listado de las categorías de los usuarios';
        ...
        function paginatorCallback(page, pageSize) {
            ...
            return $http.get(GlobalsService.getAPIURL() + '/api/userCategories?' + $.param( params ) ).then(function(result){
